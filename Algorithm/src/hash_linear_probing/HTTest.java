...
public class HTTest {
	...
	public static void main(String[] args) throws IOException {
		...
		if (theHashTable.contains("#DEL#")) {
			System.out.println("Found: '#DEL#'");
		} else
			System.out.println("Cannot find: '#DEL#'");
		System.out.println("");

		System.out.println("Hash value of '#DEL#': "
				+ theHashTable.hashValue("#DEL#"));
		...
		System.out.println("Number of items: " + theHashTable.size());
		System.out.println("Frequency of '#DEL#': "
				+ theHashTable.showFrequency("#DEL#"));
