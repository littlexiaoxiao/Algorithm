...
public class SendEmail {  
    ...
    public static void main(String[] args) {  
        String[] recipients = new String[]{"jovenmou@gmail.com"};  
        String[] bccRecipients = new String[]{"jovenmou@gmail.com"};  
        String subject = "Hi this is test Mail";  
        String messageBody = "Hi,this is from Neighborhood Allies Pittsburgh ";  
